...
public interface ChangeLogRepository extends JpaRepository<ChangeLog, Long>
{
  ...
  @Query(value = """
       ...
       AND   (:atFrom IS NULL OR l.createdAt >= :atFrom)
       AND   (:atTo IS NULL OR l.createdAt <= :atTo)
       AND   (:cursorAt IS NULL OR (l.createdAt < :cursorAt OR (l.createdAt = :cursorAt AND l.id < :idAfter)))
      ORDER BY l.createdAt DESC, l.id DESC
      """)
  List<ChangeLog> findByAtDesc(String employeeNumber, ChangeType type,
      String memo, String ipAddress, Instant atFrom, Instant atTo,
      Instant cursorAt, Long idAfter, Pageable pageable);
  ...
  @Query("""
      ...
      """)
  List<ChangeLog> findByAtAsc(String employeeNumber, ChangeType type,
      String memo, String ipAddress, Instant atFrom, Instant atTo,
      Instant cursorAt, Long idAfter, Pageable pageable);
  ...
  @Query("""
       ...
       AND   (:atFrom IS NULL OR l.createdAt >= :atFrom)
       AND   (:atTo IS NULL OR l.createdAt <= :atTo)
       AND   (:cursorIp IS NULL OR (l.ipAddress < :cursorIp OR (l.ipAddress = :cursorIp AND l.id < :idAfter)))
      ORDER BY l.ipAddress DESC, l.id DESC
      """)
  List<ChangeLog> findByIpDesc(String employeeNumber, ChangeType type,
      String memo, String ipAddress, Instant atFrom, Instant atTo,
      String cursorIp, Long idAfter, Pageable pageable);
  ...
  @Query("""
      ...
      """)
  List<ChangeLog> findByIpAsc(String employeeNumber, ChangeType type,
      String memo, String ipAddress, Instant atFrom, Instant atTo,
      String cursorIp, Long idAfter, Pageable pageable);
