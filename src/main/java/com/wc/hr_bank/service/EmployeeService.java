...

{
     ...
     * 프로필 이미지는 선택이며, 제출 시 파일 관리 규칙에 따라 저장·연결됩니다.
     */
     ...
     * 프로필 이미지 수정 시 새 파일을 제출하면 기존 이미지를 대체합니다.
     */
     ...
     * 규칙: 삭제 시 연관된 프로필 이미지(DB·파일)도 함께 제거됩니다.
     * 퇴사 상태(RESIGNED)인 직원은 삭제할 수 없으며, 이 경우 IllegalArgumentException이 발생합니다.
     */
